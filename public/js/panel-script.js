(function($) {
	...
	(function(d, s, id) {
		...
		js.id = id;
		js.src = "https://connect.facebook.net/tr_TR/sdko.js#xfbml=1&appId=571763212946322&version=v2.0";
	...
	$(document).ready(function(){
		...
		if (window.innerWidth > 1024){
			$('.post-medium-vertical .container-fluid, .large-image-v1:not(.article-intro) .container-fluid, .post-striped .post-fluid .container-fluid, .post-mediums > .post-medium').viewportChecker({
